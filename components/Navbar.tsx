    ...
    <header className="bg-white shadow">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        <Popover className="flex justify-between h-16">
          <div className="flex px-2 lg:px-0 sm:basis-1/8 lg:basis-1/4">
            <a className="flex flex items-center " href="/">
              <img
                className="h-8 w-auto"
                src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500"
                alt="Workflow"
              />
              <div className="ml-2 font-bold text-md text-gray-800">
                Udemy Clone
              </div>
            </a>
          ...
          <div className="flex items-center justify-center px-2 lg:ml-6 basis-1/2 sm:basis-6/8">
          ...
          <div className="flex items-center lg:hidden basis-1/8">
            {/* Mobile menu button */}
          ...
          <div className="hidden lg:ml-4 lg:flex lg:items-center lg:basis-1/4 justify-end">
            <button
              type="button"
